...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'a548a20d428044d09e7f20d74833de06',
  ...
  SINCE: process.env.NEXT_SINCE || 2022, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ShareStuff', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '阿刚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sharestuff.top/', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/iShareStuff', // 你的github个人主页 例如 https://github.com/tangly1024
