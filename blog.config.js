...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'a548a20d428044d09e7f20d74833de06',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'pubtools', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '阿刚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pubtools.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Magic, Tools', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1037388002@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/pubtools', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'pubtools', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'share', // 站点描述，被notion中的页面描述覆盖
